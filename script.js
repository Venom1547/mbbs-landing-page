...
// Form validation for Apply Now form
 document.getElementById("applyForm").addEventListener("submit", function(event) {
        ...
        // ✅ Fixing Google Form Pre-Fill Link (No line breaks!)
        let googleFormURL = `https://docs.google.com/forms/d/e/1FAIpQLSffrxJsg2AbGKtvoeb3BsPMBa3REum3THhia3vuDmWRmZphaw/viewform?usp=pp_url&entry.2005620554=${encodedName}&entry.1045781291=${encodedEmail}&entry.1166974658=${encodedPhone}&entry.839337160=${encodedCountry}`;
